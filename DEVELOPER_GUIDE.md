...
```bash
git clone https://github.com/awesome-panel/data-app-converter.git
cd data-app-converter
pip install pip -U
...
Update the version in the [__init__.py](src/data_app_converter/__init__.py).
